# ifndef LOOKUP_TYPE_H
# define LOOKUP_TYPE_H
...
inline bool isImplicitSelfLookupType(LookupType t) {
  return t & ImplicitSelfBit;
}
...
inline bool lookupReceiverIsSelf(LookupType l) {
  if (isImplicitSelfLookupType(l)) return true;
  BaseLookupType bl = baseLookupType(l);
  return (bl == ResendBaseLookupType ||
          bl == DirectedResendBaseLookupType);
}
